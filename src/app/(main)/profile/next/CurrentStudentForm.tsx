...
import { CurrentStudentFormData, currentStudentSchema } from "@/utils/validations/currentStudentSchema";
...
export default function CurrentStudentForm({
    ...
    const form = useForm<CurrentStudentFormData>({
        ...
        defaultValues: {
            enrolled_university: "",
            program_of_study: "",
            current_year_of_study: "undergraduate",
            expected_grad_month: "",
            expected_grad_year: "",
            student_visa_status: "f1",
        },
    });
